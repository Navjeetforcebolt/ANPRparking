...
class UserUI(QMainWindow):
    def __init__(self):
        ...
        loadUi(r"C:\Users\Cloudanalogy\Desktop\Parking-system-with-ANPR\uiuser.ui",self)
        width=1200
        height=720
...
class AdminUI(QMainWindow):
    def __init__(self):
        ...
        loadUi(r"C:\Users\Cloudanalogy\Desktop\Parking-system-with-ANPR\ui.ui",self)
        width = 1200
        height = 720
        self.setMinimumSize(width, height)
    ...
    def loaddata(self):
        #use self.table...
        with open(r'C:\Users\Cloudanalogy\Desktop\Parking-system-with-ANPR\data.csv', 'r') as file:
