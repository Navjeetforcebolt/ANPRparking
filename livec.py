...
pytesseract.pytesseract.tesseract_cmd = r'C:\Users\Cloudanalogy\Desktop\Parking-system-with-ANPR\tesseract.exe'
...
# Initialize the camera capture (you may need to change the camera index)
...
while True:
    ...
    processed_frame, text = extract_text_from_frame(frame)

    # Display the processed frame with extracted text
